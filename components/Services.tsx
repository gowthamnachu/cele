...
function SpotlightCard({ service, index }: { service: any; index: number }) {
    ...
    return (
        <motion.div
            ...
            className="group relative p-12 md:p-20 border-b border-r border-white/5 overflow-hidden bg-[#0a0a0a]"
        >
            <motion.div
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
                <div>
                    ...
                    <h3 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tighter leading-[0.8] mb-8 group-hover:translate-x-3 transition-transform duration-700">
                        {service.title.split(' ')[0]} <br />
                        <span className="text-white/20 group-hover:text-white transition-colors duration-700">
                            {service.title.split(' ')[1]}
                        </span>
                    </h3>
                    <p className="text-white/40 text-sm leading-relaxed max-w-xs font-light transition-colors group-hover:text-white/60">
                        {service.description}
                    </p>
                </div>

                <div className="pt-12 opacity-0 group-hover:opacity-100 transition-all transform translate-y-6 group-hover:translate-y-0 duration-700">
                    <motion.div
                        whileHover={{ x: 10 }}
            ...
            <div className="container mx-auto px-6 md:px-12">
                <div className="max-w-3xl mb-32">
                    <motion.p
                        ...
                        viewport={{ once: true }}
                        className="text-white/30 uppercase tracking-[0.5em] text-[10px] font-black mb-8"
                    >
                        Core Competencies
                    </motion.p>
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                        className="text-6xl md:text-9xl font-black uppercase tracking-[-0.04em] leading-[0.85] text-white"
                    >
